...
namespace MVCCore.Infrastructure.DependencyManagement
{
    /// <summary>
    ...
    public class ContainerConfigurer
    {
        ...
        public virtual void Configure(IEngine engine, ContainerManager containerManager, EventBroker broker, MVCCoreConfig configuration)
        {
            //other dependencies
            containerManager.AddComponentInstance<MVCCoreConfig>(configuration, "mvccore.configuration");
            containerManager.AddComponentInstance<IEngine>(engine, "mvccore.engine");
            containerManager.AddComponentInstance<ContainerConfigurer>(this, "mvccore.containerConfigurer");

            //type finder
            containerManager.AddComponent<ITypeFinder, WebAppTypeFinder>("mvccore.typeFinder");
            ...
            containerManager.AddComponent<DependencyAttributeRegistrator>("mvccore.serviceRegistrator");
        ...
        protected virtual string[] GetComponentConfigurations(MVCCoreConfig configuration)
        {
