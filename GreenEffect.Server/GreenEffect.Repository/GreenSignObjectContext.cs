...
using GreenSign.Repository.EF.Configuration;

namespace GreenSign.Repository.EF
{
    /// <summary>
    /// Object context
    /// </summary>
    public class GreenSignObjectContext : DbContext, IDbContext
    {
        public GreenSignObjectContext(string nameOrConnectionString)
